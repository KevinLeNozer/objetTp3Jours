...
public class TestPlan {
    public static void main(String[] args) {
        ...
        System.out.println("Les informations de la terrasse A sont : "+terrasseA.affiche()); Terrasse terrasseB=new Terrasse(Color.YELLOW.getRGB(),8,204); Terrasse terrasseC=new Terrasse(Color.RED.getRGB(),102,4); Etalage etalageA=new Etalage(Color.WHITE.getRGB(),120,204);
